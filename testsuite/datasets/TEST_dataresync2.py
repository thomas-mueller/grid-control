...
class Test_SplitterResync2:
	"""
	# Initial splitting
	>>> DataProvider.saveToFile('data-old.dbs', getBlock2(5))
	>>> doInitSplit()
	/path/file_a: A
	/path/file_b: B
	/path/file_c: C
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock2(5))
	>>> doResync()
	([], [], False)
	/path/file_a: A
	/path/file_b: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock2(7))
	>>> doResync()
	([], [], True)
	/path/file_a: A
	/path/file_b: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock2(10))
	>>> doResync()
	([], [], True)
	/path/file_a: A
	/path/file_b: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock2(8))
	>>> doResync()
	([], [5], True)
	/path/file_a: A
	/path/file_b: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock2(11))
	>>> doResync()
	([], [], True)
	/path/file_a: A
	/path/file_b: B
