...
class Test_SplitterResync4:
	"""
	# Initial splitting
	>>> DataProvider.saveToFile('data-old.dbs', getBlock4(1))
	>>> doInitSplit()
	/path/file_x: A
	/path/file_y: B
	/path/file_z: C
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock4(1))
	>>> doResync()
	([], [], False)
	/path/file_x: A
	/path/file_y: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock4(3))
	>>> doResync()
	([], [1], True)
	/path/file_x: A
	/path/file_y: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock4(7))
	>>> doResync()
	([], [3], True)
	/path/file_x: A
	/path/file_y: B
