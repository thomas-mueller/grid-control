...
class Test_SplitterResyncMeta:
	...
	>>> doInitSplit(doprint = False, nEvent = 15, srcFN = "dataI.dbs")
	>>> printSplit(DataSplitter.loadPartitionsForScript("datamap-resync.tar"), meta = True)
	...
	>>> doResync(doprint = False, configDict = {'dataset': cfg}, srcFN = "dataI.dbs", modFN = "dataJ.dbs", doRename = False)
	>>> printSplit(DataSplitter.loadPartitionsForScript("datamap-resync.tar"), meta = True)
	x|SIZE|SKIP|Files|Metadata|Invalid
