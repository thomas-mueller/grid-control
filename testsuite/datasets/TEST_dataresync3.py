...
def getBlock3(nEvent):
	return [{
		...
		DP.Nickname: 'TESTNICK', DP.DatasetID: 111, DP.Metadata: ['KEY1', 'KEY2'],
		DP.FileList: [
...
class Test_SplitterResync3:
	"""
	# Initial splitting
	>>> DataProvider.saveToFile('data-old.dbs', getBlock3(4))
	>>> doInitSplit()
	/path/file_x: A
	/path/file_y: B
	/path/file_z: C
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock3(4))
	>>> doResync()
	([], [], False)
	/path/file_x: A
	/path/file_y: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock3(7))
	>>> doResync()
	([], [1], True)
	/path/file_x: A
	/path/file_y: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock3(10))
	>>> doResync()
	([], [3], True)
	/path/file_x: A
	/path/file_y: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock3(8))
	>>> doResync()
	([], [4], True)
	/path/file_x: A
	/path/file_y: B
	...
	>>> DataProvider.saveToFile('data-new.dbs', getBlock3(11))
	>>> doResync()
	([], [5], True)
	/path/file_x: A
	/path/file_y: B
	...
	>>> remove_files(['data-new.dbs', 'data-old.dbs', 'datamap-resync.tar', 'datamap-resync-new.tar'])
	"""
